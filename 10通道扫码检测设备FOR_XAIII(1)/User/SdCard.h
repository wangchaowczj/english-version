...
/**@defgroup SPI_PinDefines
  *@{
  */  
#define SDCARD_SPI_SCLK_PORT              GPIOA 
#define SDCARD_SPI_SCLK_PORT_RCC          RCC_AHB1Periph_GPIOA
#define SDCARD_SPI_SCLK_PIN               GPIO_Pin_5

#define SDCARD_SPI_MISO_PORT              GPIOA
#define SDCARD_SPI_MISO_PORT_RCC          RCC_AHB1Periph_GPIOA
#define SDCARD_SPI_MISO_PIN               GPIO_Pin_6

#define SDCARD_SPI_MOSI_PORT              GPIOA
#define SDCARD_SPI_MOSI_PORT_RCC          RCC_AHB1Periph_GPIOA
#define SDCARD_SPI_MOSI_PIN               GPIO_Pin_7

#define SDCARD_SPI_CS_PORT       		  GPIOA
#define SDCARD_SPI_CS_PORT_RCC    		  RCC_AHB1Periph_GPIOA
#define SDCARD_SPI_CS_PIN         		  GPIO_Pin_4
