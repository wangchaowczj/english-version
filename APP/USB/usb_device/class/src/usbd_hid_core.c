...
char UsbHidReceiveComplete=0;		//标志位，用于表示是否有数据接收
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x02,         /*bNumEndpoints*/
  //修改为0x02----0x01,         /*bNumEndpoints*/
  0x03,         /*bInterfaceClass: HID*/
  0x00,         /*bInterfaceSubClass : 1=BOOT, 0=no boot*/
  0x00,         /*nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse*/
  //修改为0x00----0x01,         /*bInterfaceSubClass : 1=BOOT, 0=no boot*/
  //修改为0x00----0x02,         /*nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse*/
...
__ALIGN_BEGIN static uint8_t USBD_HID_Desc[USB_HID_DESC_SIZ] __ALIGN_END=
{
  ...
  #endif
#endif /* USB_OTG_HS_INTERNAL_DMA_ENABLED */  
__ALIGN_BEGIN static uint8_t HID_CUSTOM_ReportDesc[HID_REPORT_DESC_SIZE] __ALIGN_END =
{
//  0x05,   0x01,
//  0x09,   0x02,
//  0xA1,   0x01,
...
{	
	...
	if ((HidData.bytenum + 64) > BUF_MAX)
	{
		HidData.bytenum = 0;
	}
	memcpy(&HidData.uch_buf[HidData.bytenum], Usb_Trans.Rxbuf, 64);
    HidData.bytenum += 64;	
	if(SlipSimpleCheck(&HidData) == SUCCESS)
	{
        AddCustomEvent(EVENT_USB);
