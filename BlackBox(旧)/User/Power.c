...
void PowerConfig(void)
{
	...
	//设置串口时钟
	RCC_AHB1PeriphClockCmd(PW_5V_SW_PORT_RCC | PW_11_3V_PROTECT_SW_RCC | PW_11_3V_PROTECT_STATE_RCC | LINAB_SHORT_SW_RCC |
	...
	/***IO_11.3OVER***/
	GPIO_InitStructure.GPIO_Pin = PW_11_3V_PROTECT_SW_PIN;	
	GPIO_Init(PW_11_3V_PROTECT_SW_PORT, &GPIO_InitStructure);
	...
	/***IO_11.3_FLT***/
	GPIO_InitStructure.GPIO_Pin = PW_11_3V_PROTECT_STATE_PIN;
	GPIO_Init(PW_11_3V_PROTECT_STATE_PORT, &GPIO_InitStructure);
