...
#define PW_11_3V_PROTECT_SW_PORT      GPIOF
#define PW_11_3V_PROTECT_SW_RCC       RCC_AHB1Periph_GPIOF
#define PW_11_3V_PROTECT_SW_PIN       GPIO_Pin_1

#define PW_11_3V_PROTECT_STATE_PORT   GPIOF
#define PW_11_3V_PROTECT_STATE_RCC    RCC_AHB1Periph_GPIOF
#define PW_11_3V_PROTECT_STATE_PIN    GPIO_Pin_2
...
#define LINAB_5V_CTRL_PORT            GPIOB
#define LINAB_5V_CTRL_RCC             RCC_AHB1Periph_GPIOB
#define LINAB_5V_CTRL_PIN             GPIO_Pin_15
...
/***电源保护电路控制***/
#define OPEN_HV_PROTECT_SW()   GPIO_SetBits(PW_11_3V_PROTECT_SW_PORT, PW_11_3V_PROTECT_SW_PIN)
#define CLOSE_HV_PROTECT_SW()  GPIO_ResetBits(PW_11_3V_PROTECT_SW_PORT, PW_11_3V_PROTECT_SW_PIN)
#define GET_HV_PROTECT_CTRL_STATE()      GPIO_ReadOutputDataBit(PW_11_3V_PROTECT_SW_PORT, PW_11_3V_PROTECT_SW_PIN)
...
/*HV和LV保护电路状态*/
#define PROTECT_DONE    0  
#define GET_HV_PROTECT_STATE() GPIO_ReadInputDataBit(PW_11_3V_PROTECT_STATE_PORT, PW_11_3V_PROTECT_STATE_PIN)
