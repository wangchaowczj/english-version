	...
	switch(prio)
	{
		...
		case APP_LED_TASK_PRIO:
			Result = OSTaskCreateExt(AppLedTask, (void*)p_arg,
					&PrivateStk.Led[APP_LED_TASK_STK_SIZE-1], APP_LED_TASK_PRIO,
					APP_LED_TASK_PRIO, &PrivateStk.Led[0], APP_LED_TASK_STK_SIZE,
					(void *)0, OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR);
			break;
		case APP_CMD_SAVE_TASK_PRIO:
			Result = OSTaskCreateExt(AppCmdSaveTask, (void*)p_arg,
					&PrivateStk.CmdSave[APP_CMD_SAVE_TASK_STK_SIZE-1], APP_CMD_SAVE_TASK_PRIO,
					APP_CMD_SAVE_TASK_PRIO, &PrivateStk.CmdSave[0], APP_CMD_SAVE_TASK_STK_SIZE,
					(void *)0, OS_TASK_OPT_STK_CHK | OS_TASK_OPT_STK_CLR);
			break;			
