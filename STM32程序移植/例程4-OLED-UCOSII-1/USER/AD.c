...
void AdcConfig(void)
{
	...
	//GPIO和ADC1时钟配置
	RCC_APB2PeriphClockCmd(AD_BAT_PORT_RCC | AD_5V_PORT_RCC | ADC1_RCC, ENABLE);

	//GPIO配置为ADC模式
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_10MHz;
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AIN;
			
	GPIO_InitStruct.GPIO_Pin = AD_BAT_PIN;
	GPIO_Init(AD_BAT_PORT, &GPIO_InitStruct);
 	
	GPIO_InitStruct.GPIO_Pin = AD_5V_PIN;
	GPIO_Init(AD_5V_PORT, &GPIO_InitStruct);
