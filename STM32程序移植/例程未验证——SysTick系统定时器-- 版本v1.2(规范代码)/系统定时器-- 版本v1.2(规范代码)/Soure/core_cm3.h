...
{ 
  ...
  SysTick->LOAD  =  (ticks & SYSTICK_MAXCOUNT) - 1;            //systickÖØ×°ÔØÖµ¼Ä´æÆ÷                                     /* set reload register */
  NVIC_SetPriority (SysTick_IRQn, (1<<__NVIC_PRIO_BITS) - 1);                              /* set Priority for Cortex-M0 System Interrupts */
  SysTick->VAL   =  (0x00);                                    //systickµ±Ç°Öµ¼Ä´æÆ÷                              /* Load the SysTick Counter Value */
  SysTick->CTRL = (1 << SYSTICK_CLKSOURCE) | (1<<SYSTICK_ENABLE) | (1<<SYSTICK_TICKINT);  //systick¿ØÖÆºÍ×´Ì¬¼Ä´æÆ÷           /* Enable SysTick IRQ and SysTick Timer */
