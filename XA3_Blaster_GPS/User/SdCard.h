...
/**@defgroup SPI_PinDefines
  *@{
  */  
#define SDCARD_SPI_SCLK_PORT              GPIOC 
#define SDCARD_SPI_SCLK_PORT_RCC          RCC_AHB1Periph_GPIOC
#define SDCARD_SPI_SCLK_PIN               GPIO_Pin_10

#define SDCARD_SPI_MISO_PORT              GPIOC
#define SDCARD_SPI_MISO_PORT_RCC          RCC_AHB1Periph_GPIOC
#define SDCARD_SPI_MISO_PIN               GPIO_Pin_11

#define SDCARD_SPI_MOSI_PORT              GPIOC
#define SDCARD_SPI_MOSI_PORT_RCC          RCC_AHB1Periph_GPIOC
#define SDCARD_SPI_MOSI_PIN               GPIO_Pin_12

#define SDCARD_SPI_CS_PORT       		  GPIOD
#define SDCARD_SPI_CS_PORT_RCC    		  RCC_AHB1Periph_GPIOD
#define SDCARD_SPI_CS_PIN         		  GPIO_Pin_2

#define SDCARD_SPI_CS_H()                 GPIO_SetBits(SDCARD_SPI_CS_PORT, SDCARD_SPI_CS_PIN)
#define SDCARD_SPI_CS_L()                 GPIO_ResetBits(SDCARD_SPI_CS_PORT, SDCARD_SPI_CS_PIN)

#define SDCARD_SPI_RCC   RCC_APB1Periph_SPI3
#define SDCARD_SPI  SPI3
...
extern uint64_t SdCardGetCapacity(void);
